...
namespace UnitTestProject1
{
    ...
    public class task11
    {
        ...
        {
          return driver.FindElement(By.XPath("//i[contains( text(),'The email address')]")).Displayed;
        ...
        public static void mainlogin (IWebDriver driver)
        {
